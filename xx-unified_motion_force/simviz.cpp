...
// redis keys:
string JOINT_ANGLES_KEY = "sai2::HapticApplications::04::simviz::sensors::q";
string JOINT_VELOCITIES_KEY = "sai2::HapticApplications::04::simviz::sensors::dq";
string ROBOT_COMMAND_TORQUES_KEY = "sai2::HapticApplications::04::simviz::actuators::fgc";

string ROBOT_SENSED_FORCE_KEY = "sai2::HapticApplications::04::simviz::sensors::sensed_force";
...
void simulation(Sai2Model::Sai2Model* robot, Simulation::Sai2Simulation* sim, ForceSensorSim* force_sensor, UIForceWidget* ui_force_widget) {
    ...
    Vector3d ui_force;
    VectorXd ui_force_command_torques = VectorXd::Zero(dof);

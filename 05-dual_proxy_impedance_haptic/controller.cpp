...
string PROXY_FEEDBACK_MIN_DIFF_KEY = "sai2::HapticApplications::03::proxy_feedback::min_diff";
string PROXY_FEEDBACK_IMPEDANCE_KEY = "sai2::HapticApplications::03::proxy_feedback::impedance";
...
//                    teleop_task->reInitializeTask();
                ...
                // use deadband for impedance haptic feedback
                Vector3d proxy_position_diff = delayed_haptic_proxy - robot_proxy;
                if(proxy_position_diff.norm() <= proxy_position_min_diff) {
                    teleop_task->_commanded_force_device = - proxy_position_damping * teleop_task->_current_trans_velocity_device;
                }
            }
            else {
